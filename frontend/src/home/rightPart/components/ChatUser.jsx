...
const ChatUser = () => {
  const { usersData, loader } = useAuth();
  ...
  return (
    <div className=" z-10">
      {loader ? (
        <div
          role="status"
          className="flex cursor-pointer justify-center h-[8vh] items-center space-x-3 bg-gray-800 hover:bg-gray-700 duration-500"
        >
          <svg
            aria-hidden="true"
        ...
        <div className="flex justify-center relative h-[8vh] items-center cursor-pointer space-x-3 bg-gray-800 hover:bg-gray-700 duration-500">
